...
const TextEditor = ({ submitButton, setsubmitButton, open }) => {
    ...
    useEffect(() => {
        const fetchNotesData = async () => {
            try {
                const response = await axios.post('https://placement-app-ifse.onrender.com/api/notes/getNotes', { username, quesId });
    ...
    useEffect(() => {
        if (submitButton) {
            const storeNotesData = async () => {
                ...
                try {
                    await axios.post('https://placement-app-ifse.onrender.com/api/notes/storeNotes', { username, quesId, notes });
